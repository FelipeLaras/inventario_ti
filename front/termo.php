...
<div class="container-fluid">
  ...
  <form action="../inc/termo.php?id=<?= $_GET['id'] ?>" method="POST">
    <div>
      <!-- Page Heading -->
      <h1 class="h6 mb-2 text-gray-800"><i class="fas fa-angle-double-right"></i> Emitir termo de todos os equipamentos ?</h1>
    ...
    <div>
      <!-- Page Heading -->
      <h1 class="h6 mb-2 text-gray-800"><i class="fas fa-angle-double-right"></i> Caso queira deixar alguma observação no termo !</h1>
