...
switch ($_POST['tipo_documento']) {
    case '1':
        ...
        if ($_POST['tipo_nota'] == 1) {
            ...
            #DIVERSOS
            $query = "INSERT INTO manager_inventario_anexo (id_funcionario, usuario, tipo_anexo, caminho, nome, tipo, data_criacao) 
            VALUES ('" . $id_funcionario . "', '" . $_SESSION['id'] . "', '" . $tipo_file . "', '" . $caminho_db . "', '" . $nome_db . "', '4', '" . $dataHoje . "')";
        }
